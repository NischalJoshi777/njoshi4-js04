...
function quoteGenerator() {
   ...
   randomQuote = randomInt(0, quoteCount-1);//Index of the last element is 9, since array indexing starts with 0
   ...
   document.getElementsByTagName("blockquote")[0].innerHTML = quote; //only one element with tag name blockquote
}
